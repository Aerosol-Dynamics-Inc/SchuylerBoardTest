 ...
 *****************************************************************************/
/*
//  fit_lnRvslnT()-- do linear interpolation between data points (from spec sheet) on ln(R) vs 1/T.  
//  The functional form of the thermistor curve (as given in the literature) is  ln(R) = Beta/T + ln(R_inf),
//  Currently using EPCOS B57861S103A39  (Digi-Key PN:495-6713-ND)  https://www.tdk-electronics.tdk.com/inf/50/db/ntc/NTC_Mini_sensors_S861.pdf
//  No longer using:  Semitec thermistors 103AT-4-70261: http://semitec-usa.com/pdf/NTCThermistor_AT.pdf
